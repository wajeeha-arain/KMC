      ...
      <div className="">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-[81px]">
          ...
          <div>
            ...
            <p
              className="mt-4 sm:mt-6 text-[15px] sm:text-[16px] lg:text-[18px] leading-[26px] text-[#051636] font-[400]
                max-w-[720px]" >
          ...
          {/*  Links */}
          <div className="grid grid-cols-2 gap-6 sm:gap-[15px] text-[#051636] text-[15px] sm:text-[16px] font-[400] leading-[100%] mt-6 lg:mt-0">
            <div className="space-y-3 sm:space-y-[35px] flex flex-col">
