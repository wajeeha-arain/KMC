        ...
        <section className="relative bg-[#eef6fb]  mx-auto">
            ...
            <div className="maincontainer mx-auto px-6 lg:px-12 pt-20 lg:pb-0 sm:pb-16 pb-10    grid lg:grid-cols-12 gap-4 items-start">
                ...
                <div className="lg:col-span-6">
                    <h1 className="text-4xl sm:text-5xl lg:text-5xl font-semibold text-slate-900 sm:leading-[58px] leading-[44px]">
                        The Starting Five:
                        <span className="block">Launch Your Team <span className="text-[#EE7A30]">With</span></span>
                    ...
                    <p className="sm:text-[18px] text-[16px] sm:mt-4 mt-2 text-slate-600 max-w-2xl">
                        Ready to scale without the stress? Our Starting Five gives you a fully managed offshore team of five—recruited,
                        onboarded, and supported by KMC.
                    </p>

                    <p className="sm:text-[24px] text-[16px] sm:mt-6 mt-4 font-medium text-balance text-[#051636]">
                        <span className="text-[#EE7A30]">FOR A LIMITED TIME</span>, WE’RE WAIVING ALL SETUP FEES ON YOUR
                        <span className="text-[#EE7A30]"> FIRST FIVE HIRES.</span>
                    </p>

                    <button className="sm:text-[16px]  text-[14px] sm:mt-8 mt-6 sm:mb-0 mb-4  inline-block bg-[#EE7A30] hover:bg-orange-600 text-white font-semibold px-6 py-4 rounded-lg shadow">
                ...
                <div className="lg:col-span-6 space-y-4">
                    {features.map((f, i) => (
                        ...
                        >
                            ...
                            <div className="sm:text-[20px] text-[16px] text-slate-900 font-bold leading-snug">{f.title}</div>
                        </div>
                    ))}
                </div>
            </div>
